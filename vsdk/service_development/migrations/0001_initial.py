# Generated by Django 3.0.5 on 2020-05-30 21:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('active', models.BooleanField(help_text='A voice service that is active is accessible to users. Marking this service as active (which is only possible when it is valid) will activate this service and deactivate all other services.', verbose_name='Voice service active')),
                ...
                ('is_pass_based_auth', models.BooleanField(default=False, help_text='A voice service that has password-based authentication will identify users by asking for their credentials (username and password).', verbose_name='Password-based authentication')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('_password', models.CharField(blank=True, max_length=100, null=True, validators=[django.core.validators.MinLengthValidator(6)], verbose_name='Password')),
