...
urlpatterns = [
    ...
    url(r'^choice/(?P<element_id>[0-9]+)/(?P<session_id>[0-9]+)$', views.ChoiceSelection.as_view(), name='choice'),
    ...
    url(r'^kasadaka-user-auth/(?P<session_id>[0-9]+)$', views.UserAuthentication.as_view(), name='kasadaka-user-auth'),
