...
from . import base
from ..models import KasaDakaUser, CallSession, lookup_kasadaka_user_by_username
...
class KasaDakaUserRegistration(TemplateView):
    ...
    def user_registration_process(self, request, session):
        ...
        # TODO: further elaborate this, user does not yet exist so you can not check there
